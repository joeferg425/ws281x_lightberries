...
# def test_pixel_creation_int_tuple() -> None:
#     """Test default pixel creation and attributes."""
#     color = (0, 0x10, 0)
#     grb_color = (0x10, 0, 0)
#     p = Pixel(color=color)
...
#     exp = "PX#001000:GRB"
#     assert str(p) == exp, f"str(Pixel): {p!s} != expected value: {exp}"
#     exp = np.array(grb_color, dtype=np.int32)
#     assert_array_equal(p.array, exp, err_msg=f"Pixel.array: {p.array} != expected value: {exp}")
#     exp = np.array(color, dtype=np.int32)
#     assert_array_equal(p.rgb_array, exp, err_msg=f"Pixel.array: {p.array} != expected value: {exp}")
#     exp = tuple(np.array(grb_color, dtype=np.int32))
#     assert p.tuple == exp, f"Pixel.tuple: {p.rgb_tuple} != expected value: {exp}"
#     exp = tuple(np.array(color, dtype=np.int32))
#     assert p.rgb_tuple == exp, f"Pixel.rgb_tuple: {p.rgb_tuple} != expected value: {exp}"
#     assert p.red == 0
#     assert p.green == 0x10  # noqa: PLR2004
#     assert p.blue == 0


# def test_pixel_creation_int_array() -> None:
#     """Test default pixel creation and attributes."""
#     color = [12, 0, 0]
#     grb_color = (0, 12, 0)
#     p = Pixel(color=color)
...
#     exp = tuple(np.array(color, dtype=np.int32))
#     assert p.rgb_tuple == exp, f"Pixel.rgb_tuple: {p.rgb_tuple} != expected value: {exp}"
#     assert p.red == 0xC  # noqa: PLR2004
#     assert p.green == 0
#     assert p.blue == 0


# def test_pixel_creation_pixel_color() -> None:
#     """Test default pixel creation and attributes."""
#     color = PixelColor.SKY
#     grb_color = (127, 0, 255)
#     p = Pixel(color=color)
#     assert isinstance(p, Pixel), f"Pixel: {p} is not {type(Pixel)}"
#     exp = 0x7F00FF
...
#     assert p.rgb_tuple == exp, f"Pixel.rgb_tuple: {p.rgb_tuple} != expected value: {exp}"
#     assert p.red == 0
#     assert p.green == 0x7F  # noqa: PLR2004
#     assert p.blue == 0xFF  # noqa: PLR2004


# def test_pixel_creation_pixel_default_order() -> None:
#     """Test default pixel creation and attributes."""
#     rgb_color = (0, 127, 255)
#     color = Pixel(PixelColor.SKY)
#     grb_color = (127, 0, 255)
#     p = Pixel(color=color)
#     assert isinstance(p, Pixel), f"Pixel: {p} is not {type(Pixel)}"
#     exp = 0x7F00FF
...
#     exp = np.array(grb_color, dtype=np.int32)
#     assert_array_equal(p.array, exp, err_msg=f"Pixel.array: {p.array} != expected value: {exp}")
#     exp = np.array(rgb_color, dtype=np.int32)
#     assert_array_equal(p.rgb_array, exp, err_msg=f"Pixel.array: {p.array} != expected value: {exp}")
#     exp = tuple(np.array(grb_color, dtype=np.int32))
#     assert p.tuple == exp, f"Pixel.tuple: {p.rgb_tuple} != expected value: {exp}"
#     exp = tuple(np.array(rgb_color, dtype=np.int32))
#     assert p.rgb_tuple == exp, f"Pixel.rgb_tuple: {p.rgb_tuple} != expected value: {exp}"
#     assert p.red == 0
#     assert p.green == 0x7F  # noqa: PLR2004
#     assert p.blue == 0xFF  # noqa: PLR2004
