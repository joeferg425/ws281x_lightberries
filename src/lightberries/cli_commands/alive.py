...
from lightberries.array_transform.alive import TransformAlive
...
def alive(  # noqa:  D103,  PLR0913
    ...
    LOGGER.critical("Running %s function", alive.__name__)
    gamma = None
    led_strip_type = None
    invert = False
    pwm_channel = 0
