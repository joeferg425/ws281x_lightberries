...
from lightberries.array_sequence.all import PixelSequence, SequenceName
from lightberries.array_sequence.named import get_named_sequence
from lightberries.array_transform.accelerate import TransformAccelerate
...
def accelerate(  # noqa:  D103,  PLR0913
    ...
    LOGGER.critical("Running %s function", accelerate.__name__)
    gamma = None
    led_strip_type = None
    invert = False
    pwm_channel = 0
