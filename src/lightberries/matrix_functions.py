...
# @transform_name("matrix")
# class MatrixFunction(LightTransform):
...
#         """
#         try:
#             LightTransform.Controller.virtualLEDBuffer[:, :] = LightTransform.Controller.virtualLEDBuffer * (
#                 1 - fade._fade_amount
#             )
...
#                 _fadeAmount = 255
#             for x in range(LightTransform.Controller.realLEDYaxisRange):
#                 for y in range(LightTransform.Controller.realLEDXaxisRange):
#                     for rgbIndex in range(len(fade._color)):
#                         if LightTransform.Controller.virtualLEDBuffer[x, y, rgbIndex] != fade._color[rgbIndex]:
#                             if (
#                                 LightTransform.Controller.virtualLEDBuffer[
#                                     x,
#                                     y,
#                                     rgbIndex,
#                                 ]
...
#                 MatrixFunction.Controller.virtual_led_buffer[:, :, 0] = np.roll(
#                     MatrixFunction.Controller.virtual_led_buffer[:, :, 0],
#                     random.randint(-1, 0),
#                     roll_index,
#                 )
#                 MatrixFunction.Controller.virtual_led_buffer[:, :, 1] = np.roll(
#                     MatrixFunction.Controller.virtual_led_buffer[:, :, 1],
#                     random.randint(-1, 0),
#                     roll_index,
#                 )
#                 MatrixFunction.Controller.virtual_led_buffer[:, :, 2] = np.roll(
#                     MatrixFunction.Controller.virtual_led_buffer[:, :, 2],
#                     random.randint(-1, 0),
#                     roll_index,
#                 )
...
#                 MatrixFunction.Controller.virtual_led_buffer = np.roll(
#                     MatrixFunction.Controller.virtual_led_buffer,
#                     -1,
#                     roll_index,
#                 )
...
#                 eye.Controller.virtual_led_buffer *= 0

#                 if eye.state == EyeMoveType.BLINK.value:
#                     xy = (tuple(eye.rowRange), tuple(eye.columnRange))
#                     eye.Controller.virtual_led_buffer[xy] = PixelColors.RED.array
#                 elif eye.state != EyeMoveType.BLINKED.value:
#                     eye._size = 3
#                     x = (
#                         np.round(
#                             np.sin(np.linspace(0, 2 * np.pi, 1 + (4 * eye._size))) * (eye._size),
...
#                     y = (
#                         np.round(
#                             np.cos(np.linspace(0, 2 * np.pi, 1 + (4 * eye._size))) * (eye._size),
#                         ).astype(dtype=np.int32)
#                         + eye.columnIndex
#                     )
...
#                 LightTransform.Controller.virtualLEDBuffer[bounceRange] = bounce._color
#             else:
#                 LightTransform.Controller.virtualLEDBuffer[bounceRange] = bounce._color
...
#                         0,
#                         firework.Controller.realLEDYaxisRange - 1,
#                     )
#                     firework.columnIndex = random.randint(
#                         0,
#                         firework.Controller.realLEDXaxisRange - 1,
#                     )
...
#             x = (
#                 np.round(
#                     np.sin(np.linspace(0, 2 * np.pi, 1 + (4 * firework._size))) * (firework._size),
#                 ).astype(dtype=np.int32)
#                 + firework.rowIndex
#             )
...
#             y = (
#                 np.round(
#                     np.cos(np.linspace(0, 2 * np.pi, 1 + (4 * firework._size))) * (firework._size),
#                 ).astype(dtype=np.int32)
...
#             firework.Controller.virtual_led_buffer[xy] = firework._color
...
#             radar.Controller.virtual_led_buffer[xy] = PixelColors.RED.array * 0.5
...
#                 radar.Controller.virtual_led_buffer[enemy[1]] = PixelColors.GREEN.array
#                 enemy[0] -= 1
#                 if enemy[0] <= 0:
...
#                 snake.Controller.virtual_led_buffer[
#                     snake.rowIndex[i],
#                     snake.columnIndex[i],
#                 ] = snake._color
